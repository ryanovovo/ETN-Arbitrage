...
class ConsoleManager:
    ...
    def state_to_terminal(self, state):
        ...
        self.stdscr.addstr(13, 0, f"最佳買價: {stock_frame['bid_price'][0]} ({stock_frame['bid_pct_chg'][0]}%){self.padding}")
        self.stdscr.addstr(14, 0, f"最佳賣價: {stock_frame['ask_price'][0]} ({stock_frame['ask_pct_chg'][0]}%){self.padding}")
